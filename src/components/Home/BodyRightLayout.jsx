      ...
      <div className='mb-10'>
          ...
          <div className='mb-10'>
            ...
            <div className='grid grid-cols-5 gap-4'>
              {/* Artist Card */}
              {albums.map((album) => (
                <div key={album.id} className='flex flex-col items-center hover:bg-slate-700 p-2 rounded-lg cursor-pointer'>
                  <div className='relative w-40 h-40'>
                    <img 
                  ...
                  <span className='text-base font-medium mt-2 self-start hover:underline hover:underline-offset-2'>{album.title}</span>
                  <span className='text-sm font-medium mt-1 self-start text-gray-400'>{album.genre}</span>
                </div>
              ))}
